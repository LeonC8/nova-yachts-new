...
export function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      <span className="rounded-full bg-white text-green-600 text-xs font-medium px-3 py-1 shadow-md border border-green-100 whitespace-nowrap">
        WhatsApp Message
      </span>
      <span className="flex items-center justify-center w-14 h-14 rounded-full bg-green-500 text-white shadow-lg hover:bg-green-600 transition-colors self-end">

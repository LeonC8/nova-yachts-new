...
export default function BoatDetails({ params }: BoatDetailsProps) {
  ...
  const prevImage = () => {
    setCurrentImageIndex(
      (prevIndex) => (prevIndex - 1 + boatImages.length) % boatImages.length
    );
  };
  ...
  const boatImages = boatDetails.otherPhotos
    ? [boatDetails.mainPhoto, ...boatDetails.otherPhotos]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8 mb-6 md:mb-12">
          <div className="lg:col-span-3 mb-4">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
              <div
                className="lg:col-span-2 relative h-[250px] lg:h-[500px] overflow-hidden rounded-lg cursor-pointer"
                onClick={() => {
              ...
              <div className="hidden lg:grid grid-cols-2 gap-2">
                {boatImages.slice(1, 5).map((img, index) => (
                  <div
                    key={index}
                    className="relative h-[245px] overflow-hidden rounded-lg cursor-pointer"
                    onClick={() => {
              ...
              <div className="grid grid-cols-4 gap-2 lg:hidden">
                {boatImages.slice(1, 5).map((img, index) => (
                  <div
                    key={index}
                    className="relative h-[60px] overflow-hidden rounded-lg cursor-pointer"
                    onClick={() => {
                      setCurrentImageIndex(index + 1);
                      setIsCarouselOpen(true);
                    }}
          ...
          <div className="lg:col-span-2">
            ...
            <section className="mb-8">
              <h2 className="text-xl text-gray-800 font-medium mb-6 pt-4">
                Details
              </h2>
              <div className="space-y-2">
                {[
                  ...
                  {
                    label: "Beam",
                    value: boatDetails.beamMeters
                      ? `${boatDetails.beamMeters} m`
                      : "-",
                  },
                  {
                    label: "Fuel capacity",
                    value: boatDetails.fuelCapacity
                      ? `${boatDetails.fuelCapacity} L`
                      : "-",
                  },
                  {
                    label: "Propulsion type",
                    value: boatDetails.propulsionType
                      ? `${boatDetails.propulsionType}`
                      : "-",
                  },
                  {
                    label: "Engine hours",
                    value: boatDetails.engineHours
                      ? `${boatDetails.engineHours}`
                      : "-",
                  },
                ].map((detail, index) => (
                  <div

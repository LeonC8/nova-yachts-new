...
export function HomePageComponent() {
  ...
  const brandCards = [
    {
      image: "https://res.cloudinary.com/dsgx9xiva/image/upload/v1659859877/nova-yachts/fairline/s68/Squadron_68_Exterior_CGI_03_1_wu7bj4.jpg",
      title: "Fairline",
      subtitle: "12 models",
      url: "https://www.fairline.com"
    },
    {
      image: "https://res.cloudinary.com/dsgx9xiva/image/upload/v1659859841/nova-yachts/numarine/32xp/slider1-32xp_jgxlq8.jpg",
      title: "Numarine",
      subtitle: "8 models",
    ...
    <div>
      ...
      <main className="flex-grow">
          ...
          <div className="relative h-[450px] md:h-[550px] overflow-hidden bg-gray-200">
            ...
            <div className="absolute inset-0 flex items-end justify-start text-white text-left pb-12 md:pb-14">
              <div className="container mx-auto px-4  xl:px-20">
                <h2 className="text-3xl md:text-4xl font-medium mb-4 font-serif md:pb-2">Fairline and Numarine Croatia</h2>
                <p className="text-sm md:text-lg text-gray-200">30 years experience | 500+ yachts sold</p>
              </div>
            </div>
        ...
        <section className="container mx-auto px-4 py-8 md:py-12 xl:px-20">
          <h2 className="text-2xl font-medium mb-2 text-left font-serif">Our Brands</h2>
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6">
                  <div className="flex justify-between items-center w-full text-white">
                    <div>
                      <h3 className="text-lg md:text-xl font-normal mb-2 md:mb-4">{brand.title}</h3>
                      <p className="text-sm font-light text-gray-200 italic">{brand.subtitle}</p>
                    </div>
          ...
          <div className="relative">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              {inStockYachts.map((yacht) => (
                <div key={yacht.id} className={`bg-white rounded border shadow-sm border-gray-0 overflow-hidden ${yacht.basicListing !== 'yes' ? 'cursor-pointer' : ''}`}>
        ...
        <section className="container mx-auto px-4 mt-0 py-10 overflow-hidden xl:px-20">
          <h2 className="text-2xl font-medium mb-4 font-serif mb-8">About Us</h2>
          <p className="text-gray-600 mb-4 text-sm">
            With over 25 years of experience in delivering premium-quality motorboats and yachts we offer a large selection off new and second-hand boats.
          </p>
          <p className="text-gray-600 text-sm">
            Together with the delivery of new boats we offer you full warranty and service assistance. We also work closely together with charter management and leasing companies.
          </p>
        </section>
        </div>
